...
public class DeviceController : MonoBehaviour {
    ...
    {
        int diff = (int)(Vector3.Distance(hitO, tempTipD)  / 0.5 * 1000);  // yama 181128 デバイス先端が仮想物体表面にどれだけ近づいたか
        ...
        if (diff > (JITTER + 20) && diff < 300 && !DtoO)        // yama 181128 一定以上近づいている&デバイスが仮想物体に触れていない場合
        {
            ...
            string str;
            float temp_prelen = (1024.0f - (Vector3.Distance(hitO, hitF) / 0.5f * 1024.0f));
            ...
            {
                str = (1024 - (int)(Vector3.Distance(hitO, hitF) / 0.5 * 1024)).ToString();
            }
